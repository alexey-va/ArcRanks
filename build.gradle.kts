...
dependencies {
    ...
    implementation("ru.ruscrafting.arc:arc-core:2.4.5")
    ...
    testImplementation("ru.ruscrafting.arc:arc-core-paper-testing:2.4.5")
    ...
    "integrationTestImplementation"("ru.ruscrafting.arc:arc-core-integration-testing:2.4.5")
