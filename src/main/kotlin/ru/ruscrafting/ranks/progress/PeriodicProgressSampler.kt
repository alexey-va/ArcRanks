...
class PeriodicProgressSampler(
    ...
    fun sample() {
        ...
        online.forEach { player ->
            buffer.recordCounter(player.uniqueId, ProgressMetric.ACTIVE_MINUTES, activeMinutes)
            ...
            if (hasCompany) buffer.recordCounter(player.uniqueId, ProgressMetric.COMMUNITY_MINUTES, activeMinutes)
